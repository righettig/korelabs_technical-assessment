...
export class AddProductProperties736926573926 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "product_properties" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "key" character varying NOT NULL, "value" jsonb, "productId" uuid, CONSTRAINT "PK_c51d81a7e32d11a7b59c13192cb" PRIMARY KEY ("id"))`);
