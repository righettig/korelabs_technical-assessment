...
export class Migration1720026827434 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tasks" ADD CONSTRAINT "FK_18a04c9720ea052eac80971ba48" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ACTION ON UPDATE NO ACTION`);
    }
